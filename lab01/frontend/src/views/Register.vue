...
<template>
  <div class="h-screen w-full flex justify-center items-center">
      <div class="w-1/2">
        <h1 class="text-center text-2xl font-bold text-neutral-900">Register a new account</h1>
        ...
        <div class="text-center text-neutral-500 mt-5 opacity-60 hover:opacity-100">
            <router-link :to="{name: 'Register'}">I have an account already</router-link>
        </div>
...
export default {
    ...
    methods: {
        ...
        handleLogin: function(){
            AUTH_API.post('/api/v1/users/register/', {
                'email': this.email,
